...
Item {
    ...
    // Top-left info panel: clock + date
    Column {
        id: infoPanel
        anchors {
            top: parent.top
        ...
        Text {
            id: timeText
            text: infoPanel.timeStr
            color: "#ffffff"
            font.pointSize: 48 * scaleFactor
    ...
    Column {
        ...
        Rectangle {
            ...
            color: "transparent"
            border.color: passwordInput.activeFocus ? "#7aa2f7" : "#2a2a4e"
            border.width: 1
            visible: showLogin
            anchors.horizontalCenter: parent.horizontalCenter
    ...
    Column {
        anchors { top: parent.top; right: parent.right; topMargin: 10 * scaleFactor; rightMargin: 10 * scaleFactor }
        ...
        Rectangle {
            ...
            Row {
                ...
                Text {
                    ...
                    visible: userHelper.currentItem
                }
                Text {
                    text: userHelper.currentItem ? userHelper.currentItem.uName : "Switch account"
                    color: "#a9b1d6"; font.pointSize: 12 * scaleFactor
                }
            }
        ...
        Rectangle {
            ...
            Row {
                ...
                spacing: 6 * scaleFactor
                Text {
                    text: sessionHelper.currentItem
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            enabled: advExpanded
                            onClicked: { advExpanded = false; sddm.suspend() }
                        }
                    }
                    Rectangle {
                        width: parent.width
                        ...
                        MouseArea {
                            ...
                            anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                            enabled: advExpanded
                            onClicked: { advExpanded = false; sddm.reboot() }
                        }
                    }
                    Rectangle {
                        width: parent.width
                        ...
                        MouseArea {
                            ...
                            anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                            enabled: advExpanded
                            onClicked: { advExpanded = false; sddm.powerOff() }
                        }
                    }
                }
            }
    ...
    // Invisible ListView helpers — bind to model declaratively (avoid JS model access)
    ListView {
        id: userHelper
    ...
    Component.onCompleted: {
        // Find initial user
        if (userHelper.count > 0) {
            userHelper.currentIndex = 0
        }
        // Find "niri" session or default to first
